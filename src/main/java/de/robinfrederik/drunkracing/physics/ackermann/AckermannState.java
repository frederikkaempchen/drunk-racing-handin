...
//the reason why this physics engine can update in 1ms intervalls
//everything gets saved in an instance of this state and that means basically no passing or creating of temporary variables
//the transition of state + passing variables to only state increased performance 10x
public class AckermannState{
    ...
    private double latVel;          // lateral velocity in local frame of the car - drift
    private double yawRate;         // derivative of yaw, angular velocity around CoM - turning rate
    private double slipEffFront;    // effective slip angles from tyre relaxation
    private double slipEffBack;     // effective slip angles from tyre relaxation
    private double slipFront;       // initial slip angles
    private double slipBack;        // initial slip angles
    private double slipRateFront;   // changing rate of slip angles - used to help alignment
    private double slipRateBack;    // changing rate of slip angles - used to help alignment
    private double latAccel;
    private double longAccel;
    private double yawRateAccel;    // changing rate of yaw rate
    private double longForceFront;
    private double longForceBack;
    private double latForceFront;
    private double latForceBack;
    private double tireGripCoeff;   //could be changed according to terrain grip
