...
//sketch for how one could create a collision physics map internally from any image
//didn't use it in the end since collision physics could be made more simple for now
